"""Callbacks for PushT expert policy training."""
...
class PushTEvalCallback(EvalCallback):
    ...
    def _log_eval_success_rate(self) -> None:
        ...
        if success_rate > self.best_success_rate:
            ...
            if self.verbose >= 1:
                print(
                    f'PushTEvalCallback: new best success rate '
    ...
    def _save_eval_video(self) -> None:
        ...
        if self.verbose >= 1:
            print(
                f'PushTEvalCallback: saved {video_path} '
