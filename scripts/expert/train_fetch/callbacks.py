"""Callbacks for Fetch expert policy training."""
...
class FetchEvalCallback(EvalCallback):
    ...
    def _log_eval_success_rate(self) -> None:
        ...
        if success_rate > self.best_success_rate:
            ...
            if self.verbose >= 1:
                print(
                    f'FetchEvalCallback: new best success rate '
    ...
    def _save_eval_video(self) -> None:
        ...
        if self.verbose >= 1:
            print(
                f'FetchEvalCallback: saved {video_path} '
