...
class MountainCarWorldModelEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        return np.asarray(obs_embedding, dtype=np.float32), {}
...
def register_mountain_car_wm_env():
    try:
        gym.spec('swm/MountainCarWM-v0')
    except gym.error.Error:
        gym.register(
            id='swm/MountainCarWM-v0',
            entry_point='env:MountainCarWorldModelEnv',
        )
