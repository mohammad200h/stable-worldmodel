...
@hydra.main(version_base=None, config_path='../config', config_name='fetch')
def run(cfg):
    """Collect random trajectories from the Fetch environment."""
    ...
    world.close()
    logging.success('Completed data collection for fetch reach expert')
